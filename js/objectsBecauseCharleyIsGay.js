...
let animelist = [
    ...
    new anime("Another", "\"Kyoumu Densen\" by ALI PROJECT", "pe3kUUW-Sw0", true, false),
    ...
    new anime("Blue Exorcist", "\"IN MY WORLD\" by ROOKiEZ is PUNK'D", "bkp8bt2yau4", true, false),
    ...
    new anime("My Hero Academia", "\"The Day\" by Porno Graffitti", "z1tC0bL2Qj4", true, false),
    ...
    new anime("Darker Than Black", "\"Howling\" by Abingdon Boys School", "35nAfhTjxfI", true, false),
    ...
    new anime("Fairy Tail (2014)", "\"MASAYUME CHASING\" by BoA", "XwJ3UrZmhWE", true, false),
    new anime("Fairy Tail (2014)", "\"STRIKE BACK\" by BACK-ON", "Ok0SLO_gtX0", true, false),
    new anime("Fairy Tail (2014)", "\"Mysterious Magic\" by Do As Infinity", "1G3HwKwfvz8", true, false),
    new anime("Fairy Tail (2014)", "\"BREAK OUT\" by V6", "-SCPxE0UO6Y", true, false),
    new anime("Fairy Tail", "\"Snow fairy\" by FUNKIST", "ZvgoZxVSZRc", true, false),
    new anime("Fairy Tail", "\"S.O.W. Sense of Wonder\" by Idoling!!!", "zrtdJ6o9X5o", true, false),
    new anime("Fairy Tail", "\"ft.\" by FUNKIST", "byBMHHcqLjs", true, false),
    new anime("Fairy Tail", "\"R.P.G. ~Rockin' Playing Game\" by SuG", "6zLT9ygXcYY", true, false),
    new anime("Fairy Tail", "\"Egao No Mahou\" by Magic Party", "bMwV_Q0z5CA", true, false),
    new anime("Fairy Tail", "\"Fiesta\" by +Plus", "x6B3UapCCIE", true, false),
    new anime("Fairy Tail", "\"Evidence\" by Daisy X Daisy", "_hljbfNXtm4", true, false),
    new anime("Fairy Tail", "\"The Rock City Boy\" by JAMIL", "Wps7xFxbVRU", true, false),
    new anime("Fairy Tail", "\"Towa no Kizuna\" by Daisy x Daisy feat. Another Infinity", "w-xLpukpaK0", true, false),
    new anime("Fairy Tail", "\"I Wish\" by Milky Bunny", "JnuHGPhr9jM", true, false),
    new anime("Fairy Tail", "\"The Starting Sky\" by +Plus", "vBEM-oF3Zms", true, false),
    new anime("Fairy Tail", "\"Tenohira\" by HERO", "wJ13GUHOPWg", true, false),
    new anime("Fairy Tail", "\"Break through\" by GOING UNDER GROUND", "RMv9ClkVtSg", true, false),
    new anime("Fairy Tail", "\"Fairy Tail ~Yakusoku no Hi~\" by Chihiro Yonekura", "UMYGMUoBJE4", true, false),
    new anime("Fullmetal Alchemist: Brotherhood", "\"again\" by YUI", "slZGg0JPOXA", true, false),
    new anime("Fullmetal Alchemist: Brotherhood", "\"Hologram\" by NICO Touches the Walls", "2sB3hD7H_-o", true, false),
    ...
    new anime("Fullmetal Alchemist: Brotherhood", "\"Rain\" by SID", "34jk4MlDfig", true, false),
    ...
    new anime("Gintama", "\"Pray\" by Tommy heavenly6", "gCzoizqQBWI", true, false),
    new anime("Gintama", "\"Tooi Nioi\" by YO-KING", "1q3nYLtqEYs", true, false),
    new anime("Gintama", "\"Giniro no Sora\" by redballoon", "BXgHjpiaeUQ", true, false),
    new anime("Gintama", "\"Kasanaru Kage\" by Hearts Grow", "ZsFudNy6skM", true, false),
    new anime("Gintama", "\"DONTEN\" by DOES", "mIu4NwF1t7E", true, false),
    new anime("Gintama", "\"Anata MAGIC\" by monobright", "7i0zvCcihZw", true, false),
    new anime("Gintama", "\"Stairway Generation\" by Base Ball Bear", "O2RYYwEBebU", true, false),
    new anime("Gintama", "\"Light Infection\" by Prague", "Qfn6gHikp9o", true, false),
    ...
    new anime("Guilty Crown", "\"Euterpe\" by EGOIST; produced by supercell; performed by Chelly", "ppDUGeUetro", true, false),
    new anime("Guilty Crown", "\"My Dearest\" by supercell; performed by Koeda", "d6LmmPgu6-w", true, false),
    new anime("Grimgar: Ashes and Illusions", "\"Knew day\" by (K)NoW_NAME", "sU9zXSma1NE", true, false),
    ...
    new anime("Hunter x Hunter (2011)", "\"departure!\" by Ono Masatoshi ", "Hecej3ztREI", true, false),
    new anime("Inu X Boku Secret Service", "\"Nirvana\" by MUCC", "c33EblvER7c", true, false),
    new anime("One Week Friends", "\"Niji no Kakera\" by Natsumi Kon", "uSFceZ6d1LY", true, false),
    ...
    new anime("Blood Blockade Battlefront", "\"Hello, world!\" by BUMP OF CHICKEN", "3Va5xN8efEQ", true, false),
    new anime("Kill la Kill", "\"Sirius\" by Eir Aoi", "NHfwCf8jE2Y", true, false),
    ...
    new anime("Magi: The Labyrinth of Magic", "\"V.I.P\" by SID", "Qvwh74yrl4M", true, false),
    ...
    new anime("The Future Diary", "\"Dead END\" by Faylan", "tGRwhqYObP4", true, false),
    ...
    new anime("Monster Musume: Everyday Life with Monster Girls", "\"Saikousoku Fall in Love\" by Miia", "fWbhAUAUVUo", true, false),
    ...
    new anime("Neon Genesis Evangelion", "\"Zankoku na Tenshi no Thesis (A Cruel Angel's Thesis)\" by Yoko Takahashi", "jSi-5tYlnUY", true, false),
    new anime("And you thought there is never a girl online?", "\"1st Love Story\" by Luce Twinkle Wink☆", "_dGPj5PBwu8", true, false),
    new anime("Nisekoi: False Love", "\"CLICK\" by ClariS", "p5A_3urfn4U", true, false),
    new anime("Nisekoi: False Love", "\"STEP\" by ClariS", "S5OJZmR5E2Y", true, false),
    new anime("Nisekoi: False Love", "\"Rally Go Round\" by LiSA", "6oyGviN5KqQ", true, false),
